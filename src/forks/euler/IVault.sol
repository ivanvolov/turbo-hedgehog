...
//     uint256 amount,
//     address receiver
// ) public virtual override callThroughEVC use(MODULE_BORROWING) returns (uint256) {}

// function repayWithShares(
//     uint256 amount,
//     address receiver
// ) public virtual override callThroughEVC use(MODULE_BORROWING) returns (uint256 shares, uint256 debt) {}
...
//     address violator,
//     address collateral
// ) public view virtual override useView(MODULE_LIQUIDATION) returns (uint256 maxRepay, uint256 maxYield) {}
// function liquidate(
//     address violator,
//     address collateral,
//     uint256 repayAssets,
...
//     address account
// ) public view virtual override useView(MODULE_BALANCE_FORWARDER) returns (bool) {}
...
//     address collateral
// ) public view virtual override useView(MODULE_GOVERNANCE) returns (uint16) {}
// function LTVFull(
//     address collateral
// )
//     public
