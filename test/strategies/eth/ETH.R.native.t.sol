...
contract ETHR_NATIVE_ALMTest is ALMTestBase {
    ...
    function setUp() public {
        ...
        {
            vm.startPrank(deployer.addr);
            PoolKey memory poolKeyETH_USDT = _getAndCheckPoolKey(
                ETH,
                IERC20(TestLib.USDT),
                500,
                10,
            ...
            setSwapAdapterToV4SingleSwap(poolKeyETH_USDT, false);
            vm.stopPrank();
        }
    }
