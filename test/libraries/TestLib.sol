...
library TestLib {
    ...
    uint256 constant sqrt_price_10per_price_change = 1048808848170150000; // (sqrt(1.1) or max 10% price change
    uint256 constant sqrt_price_1per_price_change = 1004987562112090000; // (sqrt(1.01) or max 1% price change
