    ...
    "anvil": {
        ...
        "advanced": {
            "run_anvil_copy: mining": (
                'anvil --fork-block-number 32827242 --fork-url "$UNICHAIN_RPC_URL" --no-storage-caching --block-time 0.5'
            ),
            "run_anvil_copy: no-mining": (
                'anvil --fork-block-number 32827242 --fork-url "$UNICHAIN_RPC_URL" --no-storage-caching'
            ),
            "set_feed": (
